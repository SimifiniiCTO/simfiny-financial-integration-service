...
AUTOGENERATED_FILES_DIR="pkg/generated/api/v1/clickhouse_financial_service.pb.gorm.go"
...
sed -i '' 's/text\[\]/Array(String)/g' pkg/generated/api/v1/clickhouse_financial_service.pb.gorm.go            