...
func (s *Server) GetMonthlyIncome(ctx context.Context, req *proto.GetMonthlyIncomeRequest) (*proto.GetMonthlyIncomeResponse, error) {
	// perform validations
	if req == nil {
	...
	return &proto.GetMonthlyIncomeResponse{
		MonthlyIncomes: res,
