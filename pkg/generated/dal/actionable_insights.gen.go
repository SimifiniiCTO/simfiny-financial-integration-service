...
func newActionableInsightORM(db *gorm.DB, opts ...gen.DOOption) actionableInsightORM {
	...
	_actionableInsightORM.actionableInsightORMDo.UseModel(&financial_integration_service_apiv1.ActionableInsightORM{})
...
type IActionableInsightORMDo interface {
	...
	Create(values ...*financial_integration_service_apiv1.ActionableInsightORM) error
	CreateInBatches(values []*financial_integration_service_apiv1.ActionableInsightORM, batchSize int) error
	Save(values ...*financial_integration_service_apiv1.ActionableInsightORM) error
	First() (*financial_integration_service_apiv1.ActionableInsightORM, error)
	Take() (*financial_integration_service_apiv1.ActionableInsightORM, error)
	Last() (*financial_integration_service_apiv1.ActionableInsightORM, error)
	Find() ([]*financial_integration_service_apiv1.ActionableInsightORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_integration_service_apiv1.ActionableInsightORM, err error)
	FindInBatches(result *[]*financial_integration_service_apiv1.ActionableInsightORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_integration_service_apiv1.ActionableInsightORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_integration_service_apiv1.ActionableInsightORM, error)
	FirstOrCreate() (*financial_integration_service_apiv1.ActionableInsightORM, error)
	FindByPage(offset int, limit int) (result []*financial_integration_service_apiv1.ActionableInsightORM, count int64, err error)
	...
	GetByUserID(user_id int) (result financial_integration_service_apiv1.ActionableInsightORM, err error)
	GetByID(id int) (result financial_integration_service_apiv1.ActionableInsightORM, err error)
	GetByIDs(ids []int) (result []financial_integration_service_apiv1.ActionableInsightORM, err error)
}
...
//
// {{end}}
func (a actionableInsightORMDo) GetByUserID(user_id int) (result financial_integration_service_apiv1.ActionableInsightORM, err error) {
...
//
// {{end}}
func (a actionableInsightORMDo) GetByID(id int) (result financial_integration_service_apiv1.ActionableInsightORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (a actionableInsightORMDo) GetByIDs(ids []int) (result []financial_integration_service_apiv1.ActionableInsightORM, err error) {
	var params []interface{}
...
func (a actionableInsightORMDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IActionableInsightORMDo {
...
func (a actionableInsightORMDo) Create(values ...*financial_integration_service_apiv1.ActionableInsightORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a actionableInsightORMDo) CreateInBatches(values []*financial_integration_service_apiv1.ActionableInsightORM, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a actionableInsightORMDo) Save(values ...*financial_integration_service_apiv1.ActionableInsightORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a actionableInsightORMDo) First() (*financial_integration_service_apiv1.ActionableInsightORM, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_integration_service_apiv1.ActionableInsightORM), nil
	}
}

func (a actionableInsightORMDo) Take() (*financial_integration_service_apiv1.ActionableInsightORM, error) {
...
func (a actionableInsightORMDo) Last() (*financial_integration_service_apiv1.ActionableInsightORM, error) {
...
func (a actionableInsightORMDo) Find() ([]*financial_integration_service_apiv1.ActionableInsightORM, error) {
	result, err := a.DO.Find()
	return result.([]*financial_integration_service_apiv1.ActionableInsightORM), err
}

func (a actionableInsightORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_integration_service_apiv1.ActionableInsightORM, err error) {
	buf := make([]*financial_integration_service_apiv1.ActionableInsightORM, 0, batchSize)
...
func (a actionableInsightORMDo) FindInBatches(result *[]*financial_integration_service_apiv1.ActionableInsightORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a actionableInsightORMDo) FirstOrInit() (*financial_integration_service_apiv1.ActionableInsightORM, error) {
...
func (a actionableInsightORMDo) FirstOrCreate() (*financial_integration_service_apiv1.ActionableInsightORM, error) {
...
func (a actionableInsightORMDo) FindByPage(offset int, limit int) (result []*financial_integration_service_apiv1.ActionableInsightORM, count int64, err error) {
...
func (a actionableInsightORMDo) Delete(models ...*financial_integration_service_apiv1.ActionableInsightORM) (result gen.ResultInfo, err error) {
