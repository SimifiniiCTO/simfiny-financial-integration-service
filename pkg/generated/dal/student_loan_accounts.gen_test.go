...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&financial_integration_service_apiv1.StudentLoanAccountORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&financial_integration_service_apiv1.StudentLoanAccountORM{}) fail: %s", err)
	}
}
...
func Test_studentLoanAccountORMQuery(t *testing.T) {
	...
	err = _do.Create(&financial_integration_service_apiv1.StudentLoanAccountORM{})
	if err != nil {
		t.Error("create item in table <student_loan_accounts> fail:", err)
	}

	err = _do.Save(&financial_integration_service_apiv1.StudentLoanAccountORM{})
	if err != nil {
		t.Error("create item in table <student_loan_accounts> fail:", err)
	}

	err = _do.CreateInBatches([]*financial_integration_service_apiv1.StudentLoanAccountORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <student_loan_accounts> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*financial_integration_service_apiv1.StudentLoanAccountORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&financial_integration_service_apiv1.StudentLoanAccountORM{}, 0, 1)
	if err != nil {
