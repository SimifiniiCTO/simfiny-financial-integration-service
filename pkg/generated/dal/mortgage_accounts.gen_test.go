...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&financial_integration_service_apiv1.MortgageAccountORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&financial_integration_service_apiv1.MortgageAccountORM{}) fail: %s", err)
	}
}
...
func Test_mortgageAccountORMQuery(t *testing.T) {
	...
	err = _do.Create(&financial_integration_service_apiv1.MortgageAccountORM{})
	if err != nil {
		t.Error("create item in table <mortgage_accounts> fail:", err)
	}

	err = _do.Save(&financial_integration_service_apiv1.MortgageAccountORM{})
	if err != nil {
		t.Error("create item in table <mortgage_accounts> fail:", err)
	}

	err = _do.CreateInBatches([]*financial_integration_service_apiv1.MortgageAccountORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <mortgage_accounts> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*financial_integration_service_apiv1.MortgageAccountORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&financial_integration_service_apiv1.MortgageAccountORM{}, 0, 1)
	if err != nil {
