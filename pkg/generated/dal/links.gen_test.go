...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&apiv1.LinkORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&apiv1.LinkORM{}) fail: %s", err)
	}
}
...
func Test_linkORMQuery(t *testing.T) {
	...
	err = _do.Create(&apiv1.LinkORM{})
	if err != nil {
		t.Error("create item in table <links> fail:", err)
	}

	err = _do.Save(&apiv1.LinkORM{})
	if err != nil {
		t.Error("create item in table <links> fail:", err)
	}

	err = _do.CreateInBatches([]*apiv1.LinkORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <links> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*apiv1.LinkORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&apiv1.LinkORM{}, 0, 1)
	if err != nil {
