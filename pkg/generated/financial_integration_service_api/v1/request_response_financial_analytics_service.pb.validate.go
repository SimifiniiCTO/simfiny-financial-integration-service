...
// Validate checks the field values on ListTransactionAggregatesRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *ListTransactionAggregatesRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListTransactionAggregatesRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// ListTransactionAggregatesRequestMultiError, or nil if none found.
func (m *ListTransactionAggregatesRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ListTransactionAggregatesRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetUserId() <= 0 {
		err := ListTransactionAggregatesRequestValidationError{
			field:  "UserId",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return ListTransactionAggregatesRequestMultiError(errors)
	}

	return nil
}

// ListTransactionAggregatesRequestMultiError is an error wrapping multiple
// validation errors returned by
// ListTransactionAggregatesRequest.ValidateAll() if the designated
// constraints aren't met.
type ListTransactionAggregatesRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListTransactionAggregatesRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListTransactionAggregatesRequestMultiError) AllErrors() []error { return m }

// ListTransactionAggregatesRequestValidationError is the validation error
// returned by ListTransactionAggregatesRequest.Validate if the designated
// constraints aren't met.
type ListTransactionAggregatesRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListTransactionAggregatesRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListTransactionAggregatesRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListTransactionAggregatesRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListTransactionAggregatesRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListTransactionAggregatesRequestValidationError) ErrorName() string {
	return "ListTransactionAggregatesRequestValidationError"
}

// Error satisfies the builtin error interface
func (e ListTransactionAggregatesRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListTransactionAggregatesRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListTransactionAggregatesRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListTransactionAggregatesRequestValidationError{}

// Validate checks the field values on ListTransactionAggregatesResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *ListTransactionAggregatesResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListTransactionAggregatesResponse
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// ListTransactionAggregatesResponseMultiError, or nil if none found.
func (m *ListTransactionAggregatesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *ListTransactionAggregatesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetAggregates() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ListTransactionAggregatesResponseValidationError{
			...
			if err := v.Validate(); err != nil {
				return ListTransactionAggregatesResponseValidationError{
					field:  fmt.Sprintf("Aggregates[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return ListTransactionAggregatesResponseMultiError(errors)
	}

	return nil
}

// ListTransactionAggregatesResponseMultiError is an error wrapping multiple
// validation errors returned by
// ListTransactionAggregatesResponse.ValidateAll() if the designated
// constraints aren't met.
type ListTransactionAggregatesResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListTransactionAggregatesResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListTransactionAggregatesResponseMultiError) AllErrors() []error { return m }

// ListTransactionAggregatesResponseValidationError is the validation error
// returned by ListTransactionAggregatesResponse.Validate if the designated
// constraints aren't met.
type ListTransactionAggregatesResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListTransactionAggregatesResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListTransactionAggregatesResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListTransactionAggregatesResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListTransactionAggregatesResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListTransactionAggregatesResponseValidationError) ErrorName() string {
	return "ListTransactionAggregatesResponseValidationError"
}

// Error satisfies the builtin error interface
func (e ListTransactionAggregatesResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListTransactionAggregatesResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListTransactionAggregatesResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListTransactionAggregatesResponseValidationError{}
