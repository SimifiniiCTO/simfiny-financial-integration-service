...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&apiv1.ReOccuringTransactionORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&apiv1.ReOccuringTransactionORM{}) fail: %s", err)
	}
}
...
func Test_reOccuringTransactionORMQuery(t *testing.T) {
	...
	err = _do.Create(&apiv1.ReOccuringTransactionORM{})
	if err != nil {
		t.Error("create item in table <re_occuring_transactions> fail:", err)
	}

	err = _do.Save(&apiv1.ReOccuringTransactionORM{})
	if err != nil {
		t.Error("create item in table <re_occuring_transactions> fail:", err)
	}

	err = _do.CreateInBatches([]*apiv1.ReOccuringTransactionORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <re_occuring_transactions> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*apiv1.ReOccuringTransactionORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&apiv1.ReOccuringTransactionORM{}, 0, 1)
	if err != nil {
