...
type UserProfileORM struct {
	BankAccounts                 []*BankAccountORM   `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	CreditAccounts               []*CreditAccountORM `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	DecryptionAccessTokenKey     string
	DecryptionAccessTokenVersion string
	Id                           uint64
	InvestmentAccounts           []*InvestmentAccountORM `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	MortgageAccounts             []*MortgageAccountORM   `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	PlaidAccessToken             string
	StripeCustomerId             string
	StudentLoanAccounts          []*StudentLoanAccountORM `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	UserId                       uint64
}
...
func (m *UserProfile) ToORM(ctx context.Context) (UserProfileORM, error) {
	...
	to.PlaidAccessToken = m.PlaidAccessToken
	to.DecryptionAccessTokenKey = m.DecryptionAccessTokenKey
	to.DecryptionAccessTokenVersion = m.DecryptionAccessTokenVersion
...
func DefaultStrictUpdateUserProfile(ctx context.Context, in *UserProfile, db *gorm.DB) (*UserProfile, error) {
	...
	filterBankAccounts.UserProfileId = new(uint64)
	*filterBankAccounts.UserProfileId = ormObj.Id
	...
	filterCreditAccounts.UserProfileId = new(uint64)
	*filterCreditAccounts.UserProfileId = ormObj.Id
	...
	filterInvestmentAccounts.UserProfileId = new(uint64)
	*filterInvestmentAccounts.UserProfileId = ormObj.Id
	...
	filterMortgageAccounts.UserProfileId = new(uint64)
	*filterMortgageAccounts.UserProfileId = ormObj.Id
	...
	filterStudentLoanAccounts.UserProfileId = new(uint64)
	*filterStudentLoanAccounts.UserProfileId = ormObj.Id
...
func DefaultApplyFieldMaskUserProfile(ctx context.Context, patchee *UserProfile, patcher *UserProfile, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*UserProfile, error) {
	...
	for _, f := range updateMask.Paths {
		...
		if f == prefix+"PlaidAccessToken" {
			patchee.PlaidAccessToken = patcher.PlaidAccessToken
			continue
		}
		if f == prefix+"DecryptionAccessTokenKey" {
			patchee.DecryptionAccessTokenKey = patcher.DecryptionAccessTokenKey
			continue
		}
		if f == prefix+"DecryptionAccessTokenVersion" {
			patchee.DecryptionAccessTokenVersion = patcher.DecryptionAccessTokenVersion
			continue
		}
