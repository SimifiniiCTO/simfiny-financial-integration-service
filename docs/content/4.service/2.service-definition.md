...
- [Protocol Documentation](#protocol-documentation)
  ...
  - [financial\_integration\_service\_api/v1/message\_financial\_service.proto](#financial_integration_service_apiv1message_financial_serviceproto)
    ...
    - [Forecast](#forecast)
    - [InvesmentHolding](#invesmentholding)
  ...
  - [financial\_integration\_service\_api/v1/clickhouse\_financial\_service.proto](#financial_integration_service_apiv1clickhouse_financial_serviceproto)
    - [AccountBalanceHistory](#accountbalancehistory)
    - [CategoryMetricsFinancialSubProfile](#categorymetricsfinancialsubprofile)
    ...
    - [ExpenseMetricsFinancialSubProfileMetrics](#expensemetricsfinancialsubprofilemetrics)
    - [FinancialProfile](#financialprofile)
    - [IncomeExpenseRatio](#incomeexpenseratio)
    - [IncomeMetrics](#incomemetrics)
    - [IncomeMetricsFinancialSubProfile](#incomemetricsfinancialsubprofile)
    - [InvestmentTransaction](#investmenttransaction)
    - [LocationFinancialSubProfile](#locationfinancialsubprofile)
    - [MelodyFinancialContext](#melodyfinancialcontext)
    - [MerchantMetricsFinancialSubProfile](#merchantmetricsfinancialsubprofile)
    - [MerchantMonthlyExpenditure](#merchantmonthlyexpenditure)
    ...
    - [PaymentChannelMetricsFinancialSubProfile](#paymentchannelmetricsfinancialsubprofile)
    - [PaymentChannelMonthlyExpenditure](#paymentchannelmonthlyexpenditure)
    - [ReOccuringTransaction](#reoccuringtransaction)
    - [TotalInvestmentBySecurity](#totalinvestmentbysecurity)
    - [Transaction](#transaction)
    - [TransactionAggregatesByMonth](#transactionaggregatesbymonth)
    - [UserFinancialHealthMetricsTable](#userfinancialhealthmetricstable)
    - [ReCurringFlow](#recurringflow)
    - [ReOccuringTransactionsFrequency](#reoccuringtransactionsfrequency)
    - [ReOccuringTransactionsStatus](#reoccuringtransactionsstatus)
  - [financial\_integration\_service\_api/v1/errors\_ignore\_financial\_service.proto](#financial_integration_service_apiv1errors_ignore_financial_serviceproto)
  ...
  - [financial\_integration\_service\_api/v1/openapi\_financial\_service.proto](#financial_integration_service_apiv1openapi_financial_serviceproto)
  - [financial\_integration\_service\_api/v1/request\_response\_financial\_analytics\_service.proto](#financial_integration_service_apiv1request_response_financial_analytics_serviceproto)
    - [GetAccountBalanceHistoryRequest](#getaccountbalancehistoryrequest)
    - [GetAccountBalanceHistoryResponse](#getaccountbalancehistoryresponse)
    - [GetCategoryMonthlyTransactionCountRequest](#getcategorymonthlytransactioncountrequest)
    - [GetCategoryMonthlyTransactionCountResponse](#getcategorymonthlytransactioncountresponse)
    - [GetDebtToIncomeRatioRequest](#getdebttoincomeratiorequest)
    - [GetDebtToIncomeRatioResponse](#getdebttoincomeratioresponse)
    - [GetExpenseMetricsRequest](#getexpensemetricsrequest)
    - [GetExpenseMetricsResponse](#getexpensemetricsresponse)
    - [GetFinancialProfileRequest](#getfinancialprofilerequest)
    - [GetFinancialProfileResponse](#getfinancialprofileresponse)
    - [GetHistoricalAccountBalanceRequest](#gethistoricalaccountbalancerequest)
    - [GetHistoricalAccountBalanceResponse](#gethistoricalaccountbalanceresponse)
    - [GetIncomeExpenseRatioRequest](#getincomeexpenseratiorequest)
    - [GetIncomeExpenseRatioResponse](#getincomeexpenseratioresponse)
    - [GetIncomeMetricsRequest](#getincomemetricsrequest)
    - [GetIncomeMetricsResponse](#getincomemetricsresponse)
    - [GetMelodyFinancialContextRequest](#getmelodyfinancialcontextrequest)
    - [GetMelodyFinancialContextResponse](#getmelodyfinancialcontextresponse)
    - [GetMerchantMonthlyExpenditureRequest](#getmerchantmonthlyexpenditurerequest)
    - [GetMerchantMonthlyExpenditureResponse](#getmerchantmonthlyexpenditureresponse)
    - [GetMonthlyBalanceRequest](#getmonthlybalancerequest)
    - [GetMonthlyBalanceResponse](#getmonthlybalanceresponse)
    - [GetMonthlyExpenditureRequest](#getmonthlyexpenditurerequest)
    - [GetMonthlyExpenditureResponse](#getmonthlyexpenditureresponse)
    - [GetMonthlyIncomeRequest](#getmonthlyincomerequest)
    - [GetMonthlyIncomeResponse](#getmonthlyincomeresponse)
    - [GetMonthlySavingsRequest](#getmonthlysavingsrequest)
    - [GetMonthlySavingsResponse](#getmonthlysavingsresponse)
    - [GetMonthlyTotalQuantityBySecurityAndUserRequest](#getmonthlytotalquantitybysecurityanduserrequest)
    - [GetMonthlyTotalQuantityBySecurityAndUserResponse](#getmonthlytotalquantitybysecurityanduserresponse)
    - [GetMonthlyTransactionCountRequest](#getmonthlytransactioncountrequest)
    - [GetMonthlyTransactionCountResponse](#getmonthlytransactioncountresponse)
    - [GetPaymentChannelMonthlyExpenditureRequest](#getpaymentchannelmonthlyexpenditurerequest)
    - [GetPaymentChannelMonthlyExpenditureResponse](#getpaymentchannelmonthlyexpenditureresponse)
    - [GetTotalInvestmentBySecurityRequest](#gettotalinvestmentbysecurityrequest)
    - [GetTotalInvestmentBySecurityResponse](#gettotalinvestmentbysecurityresponse)
    - [GetTransactionAggregatesRequest](#gettransactionaggregatesrequest)
    - [GetTransactionAggregatesResponse](#gettransactionaggregatesresponse)
    - [GetUserAccountBalanceHistoryRequest](#getuseraccountbalancehistoryrequest)
    - [GetUserAccountBalanceHistoryResponse](#getuseraccountbalancehistoryresponse)
    - [GetUserCategoryMonthlyExpenditureRequest](#getusercategorymonthlyexpenditurerequest)
    - [GetUserCategoryMonthlyExpenditureResponse](#getusercategorymonthlyexpenditureresponse)
    - [GetUserCategoryMonthlyIncomeRequest](#getusercategorymonthlyincomerequest)
    - [GetUserCategoryMonthlyIncomeResponse](#getusercategorymonthlyincomeresponse)
  - [financial\_integration\_service\_api/v1/request\_response\_financial\_service.proto](#financial_integration_service_apiv1request_response_financial_serviceproto)
    ...
    - [CreateManualLinkResponse](#createmanuallinkresponse)
    ...
    - [CreateSmartGoalResponse](#createsmartgoalresponse)
    ...
    - [DeleteMilestoneResponse](#deletemilestoneresponse)
    - [DeleteSmartGoalRequest](#deletesmartgoalrequest)
    - [DeleteSmartGoalResponse](#deletesmartgoalresponse)
    - [DeleteUserProfileRequest](#deleteuserprofilerequest)
    - [DeleteUserProfileResponse](#deleteuserprofileresponse)
    - [GetAllBudgetsRequest](#getallbudgetsrequest)
    - [GetAllBudgetsResponse](#getallbudgetsresponse)
    ...
    - [GetInvestmentAcccountRequest](#getinvestmentacccountrequest)
    - [GetInvestmentAcccountResponse](#getinvestmentacccountresponse)
    - [GetLiabilityAccountRequest](#getliabilityaccountrequest)
    - [GetLiabilityAccountResponse](#getliabilityaccountresponse)
    ...
    - [GetMilestonesBySmartGoalIdRequest](#getmilestonesbysmartgoalidrequest)
    - [GetMilestonesBySmartGoalIdResponse](#getmilestonesbysmartgoalidresponse)
    - [GetMortgageAccountRequest](#getmortgageaccountrequest)
    - [GetMortgageAccountResponse](#getmortgageaccountresponse)
    - [GetPocketRequest](#getpocketrequest)
    - [GetPocketResponse](#getpocketresponse)
    - [GetReCurringTransactionsRequest](#getrecurringtransactionsrequest)
    - [GetReCurringTransactionsResponse](#getrecurringtransactionsresponse)
    - [GetReCurringTransactionsResponse.ParticipantReCurringTransactions](#getrecurringtransactionsresponseparticipantrecurringtransactions)
    - [GetSmartGoalsByPocketIdRequest](#getsmartgoalsbypocketidrequest)
    - [GetSmartGoalsByPocketIdResponse](#getsmartgoalsbypocketidresponse)
    - [GetStudentLoanAccountRequest](#getstudentloanaccountrequest)
    - [GetStudentLoanAccountResponse](#getstudentloanaccountresponse)
    - [GetTransactionsForBankAccountRequest](#gettransactionsforbankaccountrequest)
    - [GetTransactionsForBankAccountResponse](#gettransactionsforbankaccountresponse)
    ...
    - [PlaidExchangeTokenResponse](#plaidexchangetokenresponse)
    - [PlaidInitiateTokenExchangeRequest](#plaidinitiatetokenexchangerequest)
    - [PlaidInitiateTokenExchangeResponse](#plaidinitiatetokenexchangeresponse)
    - [PlaidInitiateTokenUpdateRequest](#plaidinitiatetokenupdaterequest)
    - [PlaidInitiateTokenUpdateResponse](#plaidinitiatetokenupdateresponse)
    - [ProcessWebhookRequest](#processwebhookrequest)
    - [ProcessWebhookRequest.ErrorEntry](#processwebhookrequesterrorentry)
    - [ProcessWebhookResponse](#processwebhookresponse)
    - [ReadynessCheckRequest](#readynesscheckrequest)
    - [ReadynessCheckResponse](#readynesscheckresponse)
    ...
    - [UpdateMilestoneResponse](#updatemilestoneresponse)
    - [UpdateSmartGoalRequest](#updatesmartgoalrequest)
    - [UpdateSmartGoalResponse](#updatesmartgoalresponse)
    - [UpdateUserProfileRequest](#updateuserprofilerequest)
    - [UpdateUserProfileResponse](#updateuserprofileresponse)
  - [financial\_integration\_service\_api/v1/service\_financial\_service.proto](#financial_integration_service_apiv1service_financial_serviceproto)
